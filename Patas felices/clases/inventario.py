...
class Inventario:
    def __init__(
        ...
        def generar_alerta(self, umbral_minimo):
            ...
            return (
                f"Produtos por debajo del umbral: {', '.join(alertas)}"
                if alertas
                else "No hay alertas por debajo del umbral"
            )
